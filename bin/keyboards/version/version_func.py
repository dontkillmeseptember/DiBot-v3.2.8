...
async def update_zero_zero_three_handler(message: types.Message):
	await bot.send_message(message.chat.id, yml_loader.version_data["version_0_0_3"]["button_update_jule_zero_two_three_info"])
