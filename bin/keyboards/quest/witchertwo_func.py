...
async def start_the_witcher_two_call(callback_query: types.CallbackQuery):
	...
	await bot.send_photo(chat_id=callback_query.message.chat.id, photo=PHOTO_THE_WITCHER_THREE, caption=yml_loader.quest_data["quest"]["thewitchertwo_info"], reply_markup=inline_keyboard)